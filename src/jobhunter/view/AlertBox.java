...
public class AlertBox {
    ...
    public static void displayError(String title, String message)
    {
        ...
        window.getIcons().add(new Image("jobhunter/resources/imgs/error.png"));
    ...
    public static void displaySuccess(String title, String message)
    {
        ...
        VBox layout = setLayout(message,window);
        Scene scene = new Scene(layout);
        window.getIcons().add(new Image("jobhunter/resources/imgs/jhlogo.png"));
        window.setScene(scene);
        window.showAndWait();
    }
}
